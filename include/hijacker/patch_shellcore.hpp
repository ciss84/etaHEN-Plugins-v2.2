...
//  installe UNE SEULE FOIS au boot (appeler patch_shellcore_mountroot_hook()).
...
// ─────────────────────────────────────────────────────────────────────────────
//  patch_shellcore_for_data — patch statique (confirme fonctionnel sur ce
//  parc de firmwares, logs a l'appui). Garde en fallback/complement du hook
//  mountroot ci-dessus tant que le pattern callsite mountroot n'est pas fiable
//  partout (ambigu sur au moins la 5.50).
// ─────────────────────────────────────────────────────────────────────────────
